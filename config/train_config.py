...
root_data_path='/root/autodl-tmp/zwk/evosnr(github ver)/data'
save_dir='/root/autodl-tmp/zwk/evosnr_0605/weights'
# #sino config
...
PCA_split_path=root_data_path+target[:4]+f'/split/'
Source_PCA_path=root_data_path+source[:4]+'/all_PCA.csv'
